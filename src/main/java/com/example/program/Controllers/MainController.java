...
public class MainController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            tableView(LoginController.daoFactory.getRequirementsDAO().getRequirements(ProjectController.project.getID_project()));
     ...
     */
    public void Add() throws IOException, SQLException, URISyntaxException {
        if (checkEmpty()) {
            ...
            LoginController.daoFactory.getRequirementsDAO().addEntity(requirements);
            tableView(LoginController.daoFactory.getRequirementsDAO().getRequirements(ProjectController.project.getID_project()));
            clear();
        }
    }
    ...
    public void Delete() throws SQLException, URISyntaxException, IOException {
        if (RequirementsTable.getSelectionModel().getSelectedItem() != null) {
            LoginController.daoFactory.getRequirementsDAO().deleteEntity(RequirementsTable.getSelectionModel().getSelectedItem());
            tableView(LoginController.daoFactory.getRequirementsDAO().getRequirements(ProjectController.project.getID_project()));
        } else {
    ...
    /**
     * Функция фильтрации требования
     *
     * @throws SQLException       исключение при работе с SQL - запросами
     * @throws URISyntaxException исключение при получении URL
     */
    public void onFilter() throws SQLException, URISyntaxException {
        tableView(LoginController.daoFactory.getRequirementsDAO().getRequirementsFilterType(comboType.getSelectionModel().getSelectedItem()));
        comboType.setValue("");
    }
    ...
    /**
     * Отчистка от фильтрации
     *
     * @throws SQLException       исключение при работе с SQL - запросами
     * @throws URISyntaxException исключение при получении URL
     */
    public void onReset() throws SQLException, URISyntaxException, IOException {
        tableView(LoginController.daoFactory.getRequirementsDAO().getRequirements(ProjectController.project.getID_project()));
        comboType.setValue("");
        clear();
    }
     ...
     * @throws URISyntaxException исключение при получении URL
     */
    public void Update() throws SQLException, URISyntaxException, IOException {
        if (checkEmpty()) {
            ...
            requirements.setSource(textSource.getText());
            requirements.setRiskAssessment(textRiskAssessment.getText());
            LoginController.daoFactory.getRequirementsDAO().updateEntity(requirements);
            tableView(LoginController.daoFactory.getRequirementsDAO().getRequirements(ProjectController.project.getID_project()));
            clear();
        }
    }
     ...
     * @throws IOException исключение потока для чтения данных
     */
    public void onTemplate(ActionEvent actionEvent) throws IOException {
        HelloApplication.downloadScene("Template.fxml", actionEvent, "Страница шаблона");
    }
