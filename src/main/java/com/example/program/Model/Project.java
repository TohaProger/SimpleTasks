...
public class Project {
    ...
    public Project() throws SQLException, URISyntaxException, IOException {
        requirementsCollection = new RequirementsCollection(LoginController.daoFactory.getRequirementsDAO()
    ...
    public void AddRequirementsCollection(Requirements requirements) {
    ...
    public boolean hasDuplicates() {
        ...
        Requirements t1, t2;
        for (int i = 0; i < count; i++) {
            t1 = requirementsCollection.requirementsCollection.get(i);
            for (int j = i + 1; j < count; j++) {
                t2 = requirementsCollection.requirementsCollection.get(j);
                if (t2.equals(t1)) {
                    return true;
                }
            }
